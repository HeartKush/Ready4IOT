! function(P, p) {
    ...
    function r(b, w, x, t, e) {
        function i() {
            var n, s, r, a;
            y = 1 < P.devicePixelRatio, x = o(x), 0 <= w.delay && setTimeout(function() {
                l(!0)
            }, w.delay), (w.delay < 0 || w.combined) && (t.e = (n = w.throttle, s = function(t) {
                "resize" === t.type && (E = z = -1), l(t.all)
            }, a = 0, function(t, e) {
                function i() {
                    a = +new Date, s.call(b, t)
                }
                var o = new Date - a;
                r && clearTimeout(r), n < o || !w.enableThrottle || e ? i() : r = setTimeout(i, n - o)
            }), t.a = function(t) {
                t = o(t), x.push.apply(x, t)
            }, t.g = function() {
                return x = F(x).filter(function() {
                    return !F(this).data(w.loadedName)
                })
            }, t.f = function(t) {
            ...
            }, l(), F(w.appendScroll).on("scroll." + e + " resize." + e, t.e))
        }

        function o(t) {
            for (var e = w.defaultImage, i = w.placeholder, o = w.imageBase, n = w.srcsetAttribute, s = w.loaderAttribute, r = w._f || {}, a = 0, l = (t = F(t).filter(function() {
                    var t = F(this),
                        e = C(this);
                    return !t.data(w.handledName) && (t.attr(w.attribute) || t.attr(n) || t.attr(s) || r[e] !== p)
                }).data("plugin_" + w.name, b)).length; a < l; a++) {
                var d = F(t[a]),
                    c = C(t[a]),
                    u = d.attr(w.imageBaseAttribute) || o;
                c === $ && u && d.attr(n) && d.attr(n, h(d.attr(n), u)), r[c] === p || d.attr(s) || d.attr(s, r[c]), c === $ && e && !d.attr(A) ? d.attr(A, e) : c === $ || !i || d.css(L) && "none" !== d.css(L) || d.css(L, "url('" + i + "')")
            }
            return t
        }
        ...
        function l(t, e) {
            if (x.length) {
                for (var i = e || x, o = !1, n = w.imageBase || "", s = w.srcsetAttribute, r = w.handledName, a = 0; a < i.length; a++)
                    if (t || e || (p = i[a], 0, f = p.getBoundingClientRect(), m = w.scrollDirection, g = w.threshold, v = (0 <= z ? z : z = F(P).height()) + g > f.top && -g < f.bottom, y = (0 <= E ? E : E = F(P).width()) + g > f.left && -g < f.right, "vertical" === m ? v : ("horizontal" === m || v) && y)) {
                        var l = F(i[a]),
                            d = C(i[a]),
                            c = l.attr(w.attribute),
                            u = l.attr(w.imageBaseAttribute) || n,
                            h = l.attr(w.loaderAttribute);
                        l.data(r) || w.visibleOnly && !l.is(":visible") || !((c || l.attr(s)) && (d === $ && (u + c !== l.attr(A) || l.attr(s) !== l.attr(I)) || d !== $ && u + c !== l.css(L)) || h) || (o = !0, l.data(r, !0), S(l, d, u, h))
                    } var p, f, m, g, v, y;
                o && (x = F(x).filter(function() {
                    return !F(this).data(r)
                }))
        ...
        function S(e, t, i, o) {
            ...
            if (o) {
                var h = function() {
                    d && e.removeAttr(w.loaderAttribute), e.data(c, !0), g(T, e), setTimeout(m, 1), h = F.noop
                };
                e.off(k).one(k, n).one(_, h), g(o, e, function(t) {
                    t ? (e.off(_), h()) : (e.off(k), n())
                }) || e.trigger(k)
            } else {
                var p = F(new Image);
                p.one(k, n).one(_, function() {
                    e.hide(), t === $ ? e.attr(D, p.attr(D)).attr(I, p.attr(I)).attr(A, p.attr(A)) : e.css(L, "url('" + p.attr(A) + "')"), e[w.effect](w.effectTime), d && (e.removeAttr(s + " " + r + " " + l + " " + w.imageBaseAttribute), a !== D && e.removeAttr(a)), e.data(c, !0), g(T, e), p.remove(), m()
                });
                var f = (y && u ? u : e.attr(s)) || "";
                p.attr(D, e.attr(a)).attr(I, e.attr(r)).attr(A, f ? i + f : null), p.complete && p.trigger(_)
            }
        }
        ...
        function g(t, e, i) {
            return (t = w[t]) && (t.apply(b, [].slice.call(arguments, 1)), 1)
        }
        var v = 0,
            E = -1,
            z = -1,
            ...
            D = "sizes",
            L = "background-image";
        "event" === w.bind || n ? i() : F(P).on(_ + "." + e, i)
    }

    function d(t, e) {
        var i = this,
            o = F.extend({}, i.config, e),
            n = {},
            s = o.name + "-" + ++a;
        return i.config = function(t, e) {
            return e === p ? o[t] : (o[t] = e, i)
        }, i.addItems = function(t) {
            return n.a && n.a("string" === F.type(t) ? F(t) : t), i
        }, i.getItems = function() {
            return n.g ? n.g() : {}
        }, i.update = function(t) {
            return n.e && n.e({}, !t), i
        }, i.force = function(t) {
            return n.f && n.f("string" === F.type(t) ? F(t) : t), i
        }, i.loadAll = function() {
            return n.e && n.e({
                all: !0
            }, !0), i
        }, i.destroy = function() {
            return F(o.appendScroll).off("." + s, n.e), F(P).off("." + s), n = {}, p
        }, r(i, o, t, n, s), o.chainable ? t : i
    }
    var F = P.jQuery || P.Zepto,
        a = 0,
        n = !1;
    F.fn.Lazy = F.fn.lazy = function(t) {
        return new d(this, t)
    }, F.Lazy = F.lazy = function(t, e, i) {
        if (F.isFunction(e) && (i = e, e = []), F.isFunction(i)) {
            t = F.isArray(t) ? t : [t], e = F.isArray(e) ? e : [e];
            for (var o = d.prototype.config, n = o._f || (o._f = {}), s = 0, r = t.length; s < r; s++) o[t[s]] !== p && !F.isFunction(o[t[s]]) || (o[t[s]] = i);
...
function(s) {
    ...
    s.lazy(["pic", "picture"], ["picture"], function(t, e) {
        if ("picture" === t[0].tagName.toLowerCase()) {
            ...
            }).appendTo(t), a(t, n + t.attr(d), e), this.config("removeAttribute") && t.removeAttr(d + " data-srcset data-media data-sizes data-type")) : e(!1)
        } else e(!1)
    })
}(window.jQuery || window.Zepto),
function(_) {
    _.isScrollToFixed = function(t) {
        return !!_(t).data("ScrollToFixed")
    }, _.ScrollToFixed = function(t, e) {
        var s = this;
        s.$el = _(t), s.el = t, s.$el.data("ScrollToFixed", s);
        var r, a, i, o, l = !1,
            d = s.$el,
            c = 0,
            u = 0,
        ...
        function C() {
            if (_.isScrollToFixed(d) && !d.is(":hidden")) {
                var t = l,
                    e = v();
                l ? v() && (c = d.offset().top, u = d.offset().left) : (d.trigger("preUnfixed.ScrollToFixed"), w(), d.trigger("unfixed.ScrollToFixed"), p = -1, c = d.offset().top, u = d.offset().left, s.options.offsets && (u += d.offset().left - d.position().left), -1 == h && (h = u), r = d.css("position"), l = !0, -1 != s.options.bottom && (d.trigger("preFixed.ScrollToFixed"), y(), d.trigger("fixed.ScrollToFixed")));
                var i = _(window).scrollLeft(),
                    o = _(window).scrollTop(),
                    n = f();
                s.options.minWidth && _(window).width() < s.options.minWidth || s.options.maxWidth && _(window).width() > s.options.maxWidth ? v() && t || (E(), d.trigger("preUnfixed.ScrollToFixed"), w(), d.trigger("unfixed.ScrollToFixed")) : -1 == s.options.bottom ? 0 < n && o >= n - S() ? e || g() && t || (E(), d.trigger("preAbsolute.ScrollToFixed"), b(), d.trigger("unfixed.ScrollToFixed")) : o >= c - S() ? (m() && t || (E(), d.trigger("preFixed.ScrollToFixed"), y(), p = -1, d.trigger("fixed.ScrollToFixed")), x(i)) : v() && t || (E(), d.trigger("preUnfixed.ScrollToFixed"), w(), d.trigger("unfixed.ScrollToFixed")) : 0 < n ? o + _(window).height() - d.outerHeight(!0) >= n - (S() || -(s.options.bottom ? s.options.bottom : 0)) ? m() && (E(), d.trigger("preUnfixed.ScrollToFixed"), ("absolute" === a ? b : w)(), d.trigger("unfixed.ScrollToFixed")) : (m() || (E(), d.trigger("preFixed.ScrollToFixed"), y()), x(i), d.trigger("fixed.ScrollToFixed")) : x(i)
            }
        }
        ...
        s.init = function() {
            s.options = _.extend({}, _.ScrollToFixed.defaultOptions, e), o = d.css("z-index"), s.$el.css("z-index", s.options.zIndex), n = _("<div />"), r = d.css("position"), a = d.css("position"), d.css("float"), i = d.css("top"), v() && s.$el.after(n), _(window).bind("resize.ScrollToFixed", z), _(window).bind("scroll.ScrollToFixed", T), "ontouchmove" in window && _(window).bind("touchmove.ScrollToFixed", C), s.options.preFixed && d.bind("preFixed.ScrollToFixed", s.options.preFixed), s.options.postFixed && d.bind("postFixed.ScrollToFixed", s.options.postFixed), s.options.preUnfixed && d.bind("preUnfixed.ScrollToFixed", s.options.preUnfixed), s.options.postUnfixed && d.bind("postUnfixed.ScrollToFixed", s.options.postUnfixed), s.options.preAbsolute && d.bind("preAbsolute.ScrollToFixed", s.options.preAbsolute), s.options.postAbsolute && d.bind("postAbsolute.ScrollToFixed", s.options.postAbsolute), s.options.fixed && d.bind("fixed.ScrollToFixed", s.options.fixed), s.options.unfixed && d.bind("unfixed.ScrollToFixed", s.options.unfixed), s.options.spacerClass && n.addClass(s.options.spacerClass), d.bind("resize.ScrollToFixed", function() {
                n.height(d.height())
            }), d.bind("scroll.ScrollToFixed", function() {
                d.trigger("preUnfixed.ScrollToFixed"), w(), d.trigger("unfixed.ScrollToFixed"), C()
            }), d.bind("detach.ScrollToFixed", function(t) {
                var e;
                (e = (e = t) || window.event).preventDefault && e.preventDefault(), e.returnValue = !1, d.trigger("preUnfixed.ScrollToFixed"), w(), d.trigger("unfixed.ScrollToFixed"), _(window).unbind("resize.ScrollToFixed", z), _(window).unbind("scroll.ScrollToFixed", T), d.unbind(".ScrollToFixed"), n.remove(), s.$el.removeData("ScrollToFixed")
            }), z()
        }, s.init()
    }, _.ScrollToFixed.defaultOptions = {
        marginTop: 0,
        limit: 0,
        bottom: -1,
        zIndex: 1e3,
        baseClassName: "scroll-to-fixed-fixed"
    }, _.fn.scrollToFixed = function(t) {
        return this.each(function() {
            new _.ScrollToFixed(this, t)
        })
    }
}(jQuery),
function(c) {
    c.extend(c.easing, {
    ...
    }), c.fn.spincrement = function(t) {
        function l(t, e) {
            if (t = t.toFixed(e), 0 < e && "." !== d.decimalPoint && (t = t.replace(".", d.decimalPoint)), d.thousandSeparator)
                for (; i.test(t);) t = t.replace(i, "$1" + d.thousandSeparator + "$2");
            return t
        }
        var d = c.extend({
                from: 0,
        ...
        return this.each(function() {
            var e, i = c(this),
                t = d.from;
            if (i.attr("data-from") && (t = parseFloat(i.attr("data-from"))), i.attr("data-to")) e = parseFloat(i.attr("data-to"));
            else if (null !== d.to) e = d.to;
            else {
                var o = -1 < c.inArray(d.thousandSeparator, ["\\", "^", "$", "*", "+", "?", "."]) ? "\\" + d.thousandSeparator : d.thousandSeparator,
                    n = new RegExp(o, "g");
                e = parseFloat(i.text().replace(n, ""))
            }
            var s, r = d.duration;
            ...
            i.css("counter", t), d.fade && i.css("opacity", 0), i.animate({
                counter: e,
                opacity: 1
            }, {
                easing: d.easing,
                ...
                complete: function() {
                    i.css("counter", null), i.html(l(e, s)), d.complete && d.complete(i)
                }
            })
        })
    }
    ...
    if ("undefined" != typeof window && window.addEventListener) {
        ...
        function p(t) {
            function e(t) {
                ...
                else(e = document.createElement("a")).href = t;
                return e.protocol.replace(/:/g, "") + e.host
            }
            if (window.XMLHttpRequest) {
                var i = new XMLHttpRequest,
                    o = e(location);
                t = e(t), i = void 0 === i.withCredentials && "" !== t && t !== o ? XDomainRequest || void 0 : XMLHttpRequest
            }
            return i
        }
        var t, f = Object.create(null),
            m = function() {},
            e = function() {
                function o() {
                    0 === --r && (m(), function() {
                        if (window.addEventListener("resize", h, !1), window.addEventListener("orientationchange", h, !1), window.MutationObserver) {
                            ...
                            t.observe(document.documentElement, {
                                ...
                                try {
                                    t.disconnect(), window.removeEventListener("resize", h, !1), window.removeEventListener("orientationchange", h, !1)
                                } catch (t) {}
                            }
                ...
                function t(t) {
                    return function() {
                        !0 !== f[t.base] && (t.useEl.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", "#" + t.hash), t.useEl.hasAttribute("href") && t.useEl.setAttribute("href", "#" + t.hash))
                    }
                }
                ...
                for (s = 0; s < a.length; s += 1) {
                    ...
                    var d = (n = a[s].getAttribute("href") || a[s].getAttributeNS("http://www.w3.org/1999/xlink", "href") || a[s].getAttribute("xlink:href")) && n.split ? n.split("#") : ["", ""],
                        c = d[0];
                    d = d[1];
                    var u = l && 0 === l.left && 0 === l.right && 0 === l.top && 0 === l.bottom;
                    l && 0 === l.width && 0 === l.height && !u ? (a[s].hasAttribute("href") && a[s].setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", n), c.length && (!0 !== (n = f[c]) && setTimeout(t({
                        useEl: a[s],
                        base: c,
                        hash: d
                    }), 0), void 0 === n && (void 0 !== (d = p(c)) && (n = new d, (f[c] = n).onload = e(n), n.onerror = i(n), n.ontimeout = i(n), n.open("GET", c), n.send(), r += 1)))) : u ? c.length && f[c] && setTimeout(t({
                        useEl: a[s],
                        base: c,
                        hash: d
                    }), 0) : void 0 === f[c] ? f[c] = !0 : f[c].onload && (f[c].abort(), delete f[c].onload, f[c] = !0)
                }
                a = "", r += 1, o()
            },
            i = function() {
    ...
    var p, f, m = h(window),
        ...
        x = {
            ...
            _initonce: function(i) {
                ...
                r.append(i), s.wrap('<div id="' + i.id + '_wrapper" class="popup_wrapper" />'), (t = h("#" + i.id + "_wrapper")).css({
                    opacity: 0,
                    visibility: "hidden",
                    position: "absolute"
                }), u && t.css("cursor", "pointer"), "overlay" == a.type && t.css("overflow", "auto"), s.css({
                    opacity: 0,
                    visibility: "hidden",
                    display: "inline-block"
                }), a.setzindex && !a.autozindex && t.css("z-index", "100001"), a.outline || s.css("outline", "none"), a.transition && (s.css("transition", a.transition), t.css("transition", a.transition)), s.attr("aria-hidden", !0), "overlay" == a.type && (s.css({
                    textAlign: "left",
                    position: "relative",
                    ...
                    left: 0,
                    textAlign: "center"
                }, a.backgroundactive && (e.position = "absolute", e.height = "0", e.overflow = "visible"), t.css(e), t.append('<div class="popup_align" />'), h(".popup_align").css({
                    display: "inline-block",
                    verticalAlign: "middle",
                    height: "100%"
                })), s.attr("role", "dialog");
                var d = a.openelement ? a.openelement : "." + i.id + c;
                h(d).each(function(t, e) {
                    h(e).attr("data-popup-ordinal", t), e.id || h(e).attr("id", "open_" + parseInt(1e8 * Math.random(), 10))
                }), s.attr("aria-labelledby") || s.attr("aria-label") || s.attr("aria-labelledby", h(d).attr("id")), "hover" == a.action ? (a.keepfocus = !1, h(d).on("mouseenter", function(t) {
                    x.show(i, h(this).data("popup-ordinal"))
                }), h(d).on("mouseleave", function(t) {
                    x.hide(i)
                })) : h(document).on("click", d, function(t) {
                    t.preventDefault();
                    var e = h(this).data("popup-ordinal");
                    setTimeout(function() {
                        x.show(i, e)
                    }, 0)
                }), a.closebutton && x.addclosebutton(i), a.detach ? s.hide().detach() : t.hide()
            },
            show: function(t, e) {
                var i = h(t);
                if (!i.data("popup-visible")) {
                    ...
                    if (S(t, e, n.beforeopen), v[t.id] = e, setTimeout(function() {
                            b.push(t.id)
                        }, 0), n.autozindex) {
                    ...
                    n.detach ? (s.prepend(t), i.show()) : s.show(), f = setTimeout(function() {
                        ...
                        "closebutton" === n.focuselement ? h("#" + t.id + " ." + t.id + "_close:first").focus() : n.focuselement ? h(n.focuselement).focus() : i.focus()
                    }, n.focusdelay)), h(n.pagecontainer).attr("aria-hidden", !0), i.attr("aria-hidden", !1), S(t, e, n.onopen), w ? s.one("transitionend", function() {
                        S(t, e, n.opentransitionend)
                    }) : S(t, e, n.opentransitionend), "tooltip" == n.type && h(window).on("resize." + t.id, function() {
                        x.reposition(t, e)
                    })
                }
            },
            hide: function(e, t) {
                var i = h.inArray(e.id, b);
                if (-1 !== i) {
                    f && clearTimeout(f);
                    var o = h("body"),
                        n = h(e),
                    ...
                    n.data("popup-visible", !1), 1 === b.length ? h("html").removeClass("popup_visible").removeClass("popup_visible_" + e.id) : h("html").hasClass("popup_visible_" + e.id) && h("html").removeClass("popup_visible_" + e.id), b.splice(i, 1), r.hasClass("popup_wrapper_visible") && r.removeClass("popup_wrapper_visible"), s.keepfocus && !t && setTimeout(function() {
                        h(n.data("focusedelementbeforepopup")).is(":visible") && n.data("focusedelementbeforepopup").focus()
                    }, 0), r.css({
                        visibility: "hidden",
                        opacity: 0
                    }), n.css({
                        ...
                        visibility: "hidden",
                        opacity: 0
                    }), h(s.pagecontainer).attr("aria-hidden", !1), n.attr("aria-hidden", !0), S(e, v[e.id], s.onclose), w && "0s" !== n.css("transition-duration") ? n.one("transitionend", function(t) {
                        n.data("popup-visible") || (s.detach ? n.hide().detach() : r.hide()), s.scrolllock && setTimeout(function() {
                            o.css({
                                overflow: "visible",
                                "margin-right": y
                            })
                        }, 10), S(e, v[e.id], s.closetransitionend)
                    }) : (s.detach ? n.hide().detach() : r.hide(), s.scrolllock && setTimeout(function() {
                        o.css({
                            overflow: "visible",
                            "margin-right": y
                        })
                    }, 10), S(e, v[e.id], s.closetransitionend)), "tooltip" == s.type && h(window).off("resize." + e.id)
                }
            },
            toggle: function(t, e) {
            ...
            reposition: function(t, e) {
                var i = h(t),
                    ...
                    n = h("#" + t.id + "_wrapper");
                h("#" + t.id + "_background");
                if (e = e || 0, "tooltip" == o.type) {
                    var s;
                    n.css({
                        position: "absolute"
                    });
                    var r = (s = o.tooltipanchor ? h(o.tooltipanchor) : o.openelement ? h(o.openelement).filter('[data-popup-ordinal="' + e + '"]') : h("." + t.id + c + '[data-popup-ordinal="' + e + '"]')).offset();
                ...
                } else "overlay" == o.type && (o.horizontal ? n.css("text-align", o.horizontal) : n.css("text-align", "center"), o.vertical ? i.css("vertical-align", o.vertical) : i.css("vertical-align", "middle"))
            },
            addclosebutton: function(t) {
                var e;
                e = h(t).data("popupoptions").closebuttonmarkup ? h(o.closebuttonmarkup).addClass(t.id + "_close") : '<button class="popup_close ' + t.id + '_close" title="Close" aria-label="Close"><span aria-hidden="true">×</span></button>', h(t).data("popup-initialized") && h(t).append(e)
            }
        },
        S = function(t, e, i) {
            var o, n, s = h(t).data("popupoptions");
            void 0 !== s && (o = s.openelement ? s.openelement : "." + t.id + c, n = h(o + '[data-popup-ordinal="' + e + '"]'), "function" == typeof i && i.call(h(t), t, n))
        };
    h(document).on("keydown", function(t) {
        if (b.length) {
            var e = b[b.length - 1],
                i = document.getElementById(e);
            h(i).data("popupoptions").escape && 27 == t.keyCode && x.hide(i)
        }
    }), h(document).on("click", function(t) {
        if (b.length) {
            var e = b[b.length - 1],
                i = document.getElementById(e),
                o = h(i).data("popupoptions").closeelement ? h(i).data("popupoptions").closeelement : "." + i.id + "_close";
            h(t.target).closest(o).length && (t.preventDefault(), x.hide(i)), h(i).data("popupoptions") && h(i).data("popupoptions").blur && !h(t.target).closest("#" + e).length && 2 !== t.which && h(t.target).is(":visible") && (h(i).data("popupoptions").background ? (x.hide(i), t.preventDefault()) : x.hide(i, !0))
        }
    }), h(document).on("keydown", function(t) {
        if (b.length && 9 == t.which) {
            var e = b[b.length - 1],
                i = document.getElementById(e),
                o = h(i).find("*").filter("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable]").filter(":visible"),
                n = h(":focus"),
                s = o.length,
                r = o.index(n);
            0 === s ? (h(i).focus(), t.preventDefault()) : t.shiftKey ? 0 === r && (o.get(s - 1).focus(), t.preventDefault()) : r == s - 1 && (o.get(0).focus(), t.preventDefault())
        }
    }), h.fn.popup = function(i) {
        return this.each(function() {
            var t = h(this);
            if ("object" == typeof i) {
                var e = h.extend({}, h.fn.popup.defaults, t.data("popupoptions"), i);
                t.data("popupoptions", e), o = t.data("popupoptions"), x._init(this)
            } else "string" == typeof i ? (t.data("popupoptions") || (t.data("popupoptions", h.fn.popup.defaults), o = t.data("popupoptions")), x[i].call(this, this)) : (t.data("popupoptions") || (t.data("popupoptions", h.fn.popup.defaults), o = t.data("popupoptions")), x._init(this))
        })
    }, h.fn.popup.defaults = {
        type: "overlay",
        autoopen: !1,
...
function(t, e) {
    ...
    "undefined" == typeof window || "function" != typeof window.getComputedStyle ? ((r = function(t) {
        ...
        return t && Array.prototype.forEach.call(t.length ? t : [t], function(t) {
            return function(n) {
                if (n && n.nodeName && "TEXTAREA" === n.nodeName && !u.has(n)) {
                    var t, i = null,
                        o = null,
                        s = null,
                        r = function() {
                        ...
                        a = function(e) {
                            window.removeEventListener("resize", r, !1), n.removeEventListener("input", c, !1), n.removeEventListener("keyup", c, !1), n.removeEventListener("autosize:destroy", a, !1), n.removeEventListener("autosize:update", c, !1), Object.keys(e).forEach(function(t) {
                                n.style[t] = e[t]
                            }), u.delete(n)
                        }.bind(n, {
                    ...
                    n.addEventListener("autosize:destroy", a, !1), "onpropertychange" in n && "oninput" in n && n.addEventListener("keyup", c, !1), window.addEventListener("resize", r, !1), n.addEventListener("input", c, !1), n.addEventListener("autosize:update", c, !1), n.style.overflowX = "hidden", n.style.wordWrap = "break-word", u.set(n, {
                        destroy: a,
                        update: c
                    }), "vertical" === (t = window.getComputedStyle(n, null)).resize ? n.style.resize = "none" : "both" === t.resize && (n.style.resize = "horizontal"), i = "content-box" === t.boxSizing ? -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) : parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth), isNaN(i) && (i = 0), c()
                }
                ...
                function c() {
                    ...
                    if (i < t ? "hidden" === e.overflowY && (l("scroll"), d(), i = "content-box" === e.boxSizing ? Math.round(parseFloat(window.getComputedStyle(n, null).height)) : n.offsetHeight) : "hidden" !== e.overflowY && (l("hidden"), d(), i = "content-box" === e.boxSizing ? Math.round(parseFloat(window.getComputedStyle(n, null).height)) : n.offsetHeight), s !== i) {
                        s = i;
    ...
    return function o(t) {
        if (function() {
                if (!C) {
                    ...
                    e.appendChild(t);
                    var i = x(t);
                    S = 200 == Math.round(y(i.width)), o.isBoxSizeOuter = S, e.removeChild(t)
                }
            ...
            for (var n = i.isBorderBox = "border-box" == e.boxSizing, s = 0; s < w; s++) {
                var r = b[s],
                    a = e[r],
                    l = parseFloat(a);
                i[r] = isNaN(l) ? 0 : l
            ...
            var v = y(e.height);
            return !1 !== v && (i.height = v + (m ? 0 : c + f)), i.innerWidth = i.width - (d + p), i.innerHeight = i.height - (c + f), i.outerWidth = i.width + u, i.outerHeight = i.height + h, i
        }
    }
}),
function(t, e) {
...
function(r, a) {
    if ("function" == typeof define && define.amd) define("flickity/js/flickity", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./cell", "./slide", "./animate"], function(t, e, i, o, n, s) {
    ...
    a.extend(f, t.prototype), f._create = function() {
        ...
        this.slideableWidth = e, this.updateSlides(), this._containSlides(), this.slidesWidth = o ? this.getLastSlide().target - this.slides[0].target : 0
        ...
        if (this.slides = [], this.cells.length) {
            ...
            this.cells.forEach(function(t, e) {
                if (o.cells.length) {
                    var i = o.outerWidth - o.firstMargin + (t.size.outerWidth - t.size[n]);
                    s.call(this, e, i) || (o.updateTarget(), o = new r(this), this.slides.push(o)), o.addCell(t)
                } else o.addCell(t)
        ...
        return function(t, e) {
            return e <= (this.size.innerWidth + 1) * o
        }
    ...
    return f.setCellAlign = function() {
        ...
        if (this.options.contain && !this.options.wrapAround && this.cells.length) {
            ...
            this.slides.forEach(function(t) {
                t.target = n ? o * this.cellAlign : (t.target = Math.max(t.target, s), Math.min(t.target, r))
            }, this)
        }
    }, f.dispatchEvent = function(t, e, i) {
        var o = e ? [e].concat(i) : i;
        if (this.emitEvent(t, o), l && this.$element) {
        ...
        !this.isDragSelect && n < o ? t += e : !this.isDragSelect && s < o && (t -= e), t < 0 ? this.x -= this.slideableWidth : e <= t && (this.x += this.slideableWidth)
        ...
        for (var o = [], n = e - t; n <= e + t; n++) {
            var s = this.options.wrapAround ? a.modulo(n, i) : n,
                r = this.slides[s];
        ...
        this.deactivate(), o.removeEventListener("resize", this), this.allOff(), this.emitEvent("destroy"), l && this.$element && l.removeData(this.element, "flickity"), delete this.element.flickityGUID, delete h[this.guid]
    }, a.extend(f, n), p.data = function(t) {
        var e = (t = a.getQueryElement(t)) && t.flickityGUID;
        return e && h[e]
    }, a.htmlInit(p, "flickity"), l && l.bridget && l.bridget("flickity", p), p.setJQuery = function(t) {
        l = t
...
function(e, i) {
    ...
    i.bindStartEvent = function(t) {
        ...
        var i = (e = void 0 === e || e) ? "addEventListener" : "removeEventListener",
            o = "mousedown";
        n.PointerEvent ? o = "pointerdown" : "ontouchstart" in n && (o = "touchstart"), t[i](o, this)
    ...
    return o.pointerDownFocus = function(t) {
        ...
        if (this.isDraggable) {
            ...
            if (this.options.freeScroll && !this.options.wrapAround) {
                ...
                this.isFreeScrolling = -o > this.slides[0].target && -o < this.getLastSlide().target
        ...
        this.dispatchEvent("staticClick", t, [e, o, n])
    }, o.onscroll = function() {
        var t = l(),
...
function(o, n) {
    "function" == typeof define && define.amd ? define("flickity/js/prev-next-button", ["./flickity", "unipointer/unipointer", "fizzy-ui-utils/utils"], function(t, e, i) {
        return n(o, t, e, i)
    }) : "object" == typeof module && module.exports ? module.exports = n(o, require("./flickity"), require("unipointer"), require("fizzy-ui-utils")) : n(o, o.Flickity, o.Unipointer, o.fizzyUIUtils)
    ...
    function s(t, e) {
        ...
        var e, i = document.createElementNS(n, "path"),
            o = "string" != typeof(e = this.parent.options.arrowShape) ? "M " + e.x0 + ",50 L " + e.x1 + "," + (e.y1 + 50) + " L " + e.x2 + "," + (e.y2 + 50) + " L " + e.x3 + ",50  L " + e.x2 + "," + (50 - e.y2) + " L " + e.x1 + "," + (50 - e.y1) + " Z" : e;
        return i.setAttribute("d", o), i.setAttribute("class", "arrow"), this.isLeft || i.setAttribute("transform", "translate(100, 100) rotate(180) "), t.appendChild(i), t
...
function(t, o) {
    "function" == typeof define && define.amd ? define("flickity/js/player", ["ev-emitter/ev-emitter", "fizzy-ui-utils/utils", "./flickity"], function(t, e, i) {
        return o(t, e, i)
    }) : "object" == typeof module && module.exports ? module.exports = o(require("ev-emitter"), require("fizzy-ui-utils"), require("./flickity")) : o(t.EvEmitter, t.fizzyUIUtils, t.Flickity)
...
function(i, o) {
    "function" == typeof define && define.amd ? define("flickity/js/add-remove-cell", ["./flickity", "fizzy-ui-utils/utils"], function(t, e) {
        return o(i, t, e)
    }) : "object" == typeof module && module.exports ? module.exports = o(i, require("./flickity"), require("fizzy-ui-utils")) : o(i, i.Flickity, i.fizzyUIUtils)
    ...
    return i.insert = function(t, e) {
        ...
        if (i && i.length) {
            ...
            e = void 0 === e ? o : e;
            var n, s, r = (n = i, s = document.createDocumentFragment(), n.forEach(function(t) {
        ...
        o && (this.selectedIndex = this.getCellSlideIndex(o)), this.selectedIndex = Math.min(this.slides.length - 1, this.selectedIndex), this.emitEvent("cellChange", [t]), this.select(this.selectedIndex), e && this.positionSliderAtSelected()
    }, e
}),
function(i, o) {
    ...
    return i._createLazyload = function() {
        ...
        var i = this.flickity.getParentCell(this.img),
            o = i && i.element;
        this.flickity.cellSizeChange(o), this.img.classList.add(e), this.flickity.dispatchEvent("lazyLoad", t, o)
    }, e.LazyLoader = n, e
}),
function(t) {
...
function(t, e) {
    ...
    o.createMethods.push("_createAsNavFor");
    var t = o.prototype;
    return t._createAsNavFor = function() {
        ...
        if (this.navCompanion) {
            var e = this.navCompanion.selectedCells[0],
                ...
                n = Math.floor((o - i) * this.navCompanion.cellAlign + i);
            if (this.selectCell(n, !1, t), this.removeNavSelectedElements(), !(n >= this.cells.length)) {
...
function(i, o) {
    "function" == typeof define && define.amd ? define(["flickity/js/index", "imagesloaded/imagesloaded"], function(t, e) {
        return o(i, t, e)
    }) : "object" == typeof module && module.exports ? module.exports = o(i, require("flickity"), require("imagesloaded")) : i.Flickity = o(i, i.Flickity, i.imagesLoaded)
}(window, function(t, e, i) {
    "use strict";
    ...
    return o._createImagesLoaded = function() {
        ...
        if (this.options.imagesLoaded) {
            ...
            i(this.slider).on("progress", function(t, e) {
                var i = o.getParentCell(e.img);
                o.cellSizeChange(i && i.element), o.options.freeScroll || o.positionSliderAtSelected()
            })
        }
    }, e
}),
    ...
    return i._createBgLazyLoad = function() {
        ...
        if (t)
            for (var e = "number" == typeof t ? t : 0, i = this.getAdjacentCellElements(e), o = 0; o < i.length; o++) {
                ...
                for (var s = n.querySelectorAll("[data-flickity-bg-lazyload]"), r = 0; r < s.length; r++) this.bgLazyLoadElem(s[r])
            }
    ...
    i.positionSliderAtSelected = function() {
        ...
        if (!(this.slides.length < 2)) {
            var t = this.getFadeIndexes(),
                e = this.slides[t.a],
                i = this.slides[t.b],
                o = this.wrapDifference(e.target, i.target),
                n = this.wrapDifference(e.target, -this.x);
            n /= o, e.setOpacity(1 - n), i.setOpacity(n);
            var s = t.a;
            this.isDragging && (s = .5 < n ? t.a : t.b), null != this.fadeHideIndex && this.fadeHideIndex != s && this.fadeHideIndex != t.a && this.fadeHideIndex != t.b && this.slides[this.fadeHideIndex].setOpacity(0), this.fadeHideIndex = s
        }
        ...
        return Math.abs(o) < Math.abs(i) && (i = o), Math.abs(n) < Math.abs(i) && (i = n), i
    };
...
function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.device = e() : t.device = e()
}(window, function() {
    return o = {}, n.m = i = [function(t, e, i) {
        ...
        function m() {
            s.landscape() ? (f("portrait"), p("landscape"), g("landscape")) : (f("landscape"), p("portrait"), g("portrait")), b()
        }
        ...
        s.macos = function() {
            ...
            return screen.orientation && Object.prototype.hasOwnProperty.call(window, "onorientationchange") ? c(screen.orientation.type, "portrait") : s.ios() && Object.prototype.hasOwnProperty.call(window, "orientation") ? 90 !== Math.abs(window.orientation) : 1 < window.innerHeight / window.innerWidth
        }, s.landscape = function() {
            return screen.orientation && Object.prototype.hasOwnProperty.call(window, "onorientationchange") ? c(screen.orientation.type, "landscape") : s.ios() && Object.prototype.hasOwnProperty.call(window, "orientation") ? 90 === Math.abs(window.orientation) : window.innerHeight / window.innerWidth < 1
        }, s.noConflict = function() {
            return window.device = n, this
        }, s.ios() ? s.ipad() ? p("ios ipad tablet") : s.iphone() ? p("ios iphone mobile") : s.ipod() && p("ios ipod mobile") : s.macos() ? p("macos desktop") : s.android() ? s.androidTablet() ? p("android tablet") : p("android mobile") : s.blackberry() ? s.blackberryTablet() ? p("blackberry tablet") : p("blackberry mobile") : s.windows() ? s.windowsTablet() ? p("windows tablet") : s.windowsPhone() ? p("windows mobile") : p("windows desktop") : s.fxos() ? s.fxosTablet() ? p("fxos tablet") : p("fxos mobile") : s.meego() ? p("meego mobile") : s.nodeWebkit() ? p("node-webkit") : s.television() ? p("television") : s.desktop() && p("desktop"), s.cordova() && p("cordova"), s.onChangeOrientation = function(t) {
    ...
    function(d, c, t) {
        ...
        function e(t) {
            "object" == typeof module && "object" == typeof module.exports ? module.exports = t : "function" == typeof define && define.amd && define("picturefill", function() {
                return t
            }), "object" == typeof d && (d.picturefill = t)
        }

        function n(t) {
            for (var e, i, o, n, s, r = t || {}, a = 0, l = (e = r.elements || u.getAllElements()).length; a < l; a++)
                if (o = (i = e[a]).parentNode, s = n = void 0, "IMG" === i.nodeName.toUpperCase() && (i[u.ns] || (i[u.ns] = {}), r.reevaluate || !i[u.ns].evaluated)) {
                    if (o && "PICTURE" === o.nodeName.toUpperCase()) {
                        if (u.removeVideoShim(o), !1 === (n = u.getMatch(i, o))) continue
                    } else n = void 0;
                    (o && "PICTURE" === o.nodeName.toUpperCase() || !u.sizesSupported && i.srcset && h.test(i.srcset)) && u.dodgeSrcset(i), n ? (s = u.processSourceSet(n), u.applyBestCandidate(s, i)) : (s = u.processSourceSet(i), void 0 !== i.srcset && !i[u.ns].srcset || u.applyBestCandidate(s, i)), i[u.ns].evaluated = !0
                }
        }
        if (d.HTMLPictureElement) e(function() {});
        else {
            c.createElement("picture");
            var o, i, u = d.picturefill || {},
                h = /\s+\+?\d+(e\d+)?w/;
            u.ns = "picturefill", u.srcsetSupported = "srcset" in t, u.sizesSupported = "sizes" in t, u.curSrcSupported = "currentSrc" in t, u.trim = function(t) {
                    return t.trim ? t.trim() : t.replace(/^\s+|\s+$/g, "")
                }, u.makeUrl = (i = c.createElement("a"), function(t) {
                    return i.href = t, i.href
                }), u.restrictsMixedContent = function() {
                    return "https:" === d.location.protocol
                }, u.matchesMedia = function(t) {
                    return d.matchMedia && d.matchMedia(t).matches
                }, u.getDpr = function() {
                    return d.devicePixelRatio || 1
                }, u.getWidthFromLength = function(t) {
                    var e;
                    if (!t || -1 < t.indexOf("%") != 0 || !(0 < parseFloat(t) || -1 < t.indexOf("calc("))) return !1;
                    t = t.replace("vw", "%"), u.lengthEl || (u.lengthEl = c.createElement("div"), u.lengthEl.style.cssText = "border:0;display:block;font-size:1em;left:0;margin:0;padding:0;position:absolute;visibility:hidden", u.lengthEl.className = "helper-from-picturefill-js"), u.lengthEl.style.width = "0px";
                    try {
                        u.lengthEl.style.width = t
                    } catch (t) {}
                    return c.body.appendChild(u.lengthEl), (e = u.lengthEl.offsetWidth) <= 0 && (e = !1), c.body.removeChild(u.lengthEl), e
                }, u.detectTypeSupport = function(t, e) {
                    var i = new d.Image;
                    return i.onerror = function() {
                        u.types[t] = !1, n()
                    }, i.onload = function() {
                        u.types[t] = 1 === i.width, n()
                    }, i.src = e, "pending"
                }, u.types = u.types || {}, u.initTypeDetects = function() {
                    u.types["image/jpeg"] = !0, u.types["image/gif"] = !0, u.types["image/png"] = !0, u.types["image/svg+xml"] = c.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), u.types["image/webp"] = u.detectTypeSupport("image/webp", "data:image/webp;base64,UklGRh4AAABXRUJQVlA4TBEAAAAvAAAAAAfQ//73v/+BiOh/AAA=")
                }, u.verifyTypeSupport = function(t) {
                    var e = t.getAttribute("type");
                    if (null === e || "" === e) return !0;
                    var i = u.types[e];
                    return "string" == typeof i && "pending" !== i ? (u.types[e] = u.detectTypeSupport(e, i), "pending") : "function" == typeof i ? (i(), "pending") : i
                }, u.parseSize = function(t) {
                    var e = /(\([^)]+\))?\s*(.+)/g.exec(t);
                    return {
                        media: e && e[1],
                        length: e && e[2]
                    }
                }, u.findWidthFromSourceSize = function(t) {
                    for (var e, i = u.trim(t).split(/\s*,\s*/), o = 0, n = i.length; o < n; o++) {
                        var s = i[o],
                            r = u.parseSize(s),
                            a = r.length,
                            l = r.media;
                        if (a && (!l || u.matchesMedia(l)) && (e = u.getWidthFromLength(a))) break
                    }
                    return e || Math.max(d.innerWidth || 0, c.documentElement.clientWidth)
                }, u.parseSrcset = function(t) {
                    for (var e = [];
                        "" !== t;) {
                        var i, o = (t = t.replace(/^\s+/g, "")).search(/\s/g),
                            n = null;
                        if (-1 !== o) {
                            if ("," !== (i = t.slice(0, o)).slice(-1) && "" !== i || (i = i.replace(/,+$/, ""), n = ""), t = t.slice(o + 1), null === n) {
                                var s = t.indexOf(",");
                                t = -1 !== s ? (n = t.slice(0, s), t.slice(s + 1)) : (n = t, "")
                            }
                        } else i = t, t = "";
                        (i || n) && e.push({
                            url: i,
                    ...
                    return e
                }, u.parseDescriptor = function(t, e) {
                    var i, o = e || "100vw",
                        n = t && t.replace(/(^\s+|\s+$)/g, ""),
                        s = u.findWidthFromSourceSize(o);
                    if (n)
                        for (var r = n.split(" "), a = r.length - 1; 0 <= a; a--) {
                            var l = r[a],
                                d = l && l.slice(l.length - 1);
                            if ("h" !== d && "w" !== d || u.sizesSupported) {
                                if ("x" === d) {
                                    var c = l && parseFloat(l, 10);
                                    i = c && !isNaN(c) ? c : 1
                                }
                            } else i = parseFloat(parseInt(l, 10) / s)
                        }
                    return i || 1
                }, u.getCandidatesFromSourceSet = function(t, e) {
                    for (var i = u.parseSrcset(t), o = [], n = 0, s = i.length; n < s; n++) {
                        var r = i[n];
                        o.push({
                            url: r.url,
                            resolution: u.parseDescriptor(r.descriptor, e)
                        })
                    }
                    return o
                }, u.dodgeSrcset = function(t) {
                    t.srcset && (t[u.ns].srcset = t.srcset, t.srcset = "", t.setAttribute("data-pfsrcset", t[u.ns].srcset))
                }, u.processSourceSet = function(t) {
                    var e = t.getAttribute("srcset"),
                        i = t.getAttribute("sizes"),
                        o = [];
                    return "IMG" === t.nodeName.toUpperCase() && t[u.ns] && t[u.ns].srcset && (e = t[u.ns].srcset), e && (o = u.getCandidatesFromSourceSet(e, i)), o
                }, u.backfaceVisibilityFix = function(t) {
                    var e = t.style || {},
                        i = "webkitBackfaceVisibility" in e,
                        o = e.zoom;
                    i && (e.zoom = ".999", i = t.offsetWidth, e.zoom = o)
                }, u.setIntrinsicSize = (o = {}, function(t, e) {
                    var i;
                    t[u.ns] && !d.pfStopIntrinsicSize && (void 0 === t[u.ns].dims && (t[u.ns].dims = t.getAttribute("width") || t.getAttribute("height")), t[u.ns].dims || (e.url in o ? s(t, o[e.url], e.resolution) : ((i = c.createElement("img")).onload = function() {
                        if (o[e.url] = i.width, !o[e.url]) try {
                            c.body.appendChild(i), o[e.url] = i.width || i.offsetWidth, c.body.removeChild(i)
                        } catch (t) {}
                        t.src === e.url && s(t, o[e.url], e.resolution), t = null, i.onload = null, i = null
                    }, i.src = e.url)))
                }), u.applyBestCandidate = function(t, e) {
                    var i, o, n;
                    t.sort(u.ascendingSort), n = t[(o = t.length) - 1];
                    for (var s = 0; s < o; s++)
                        if ((i = t[s]).resolution >= u.getDpr()) {
                            n = i;
                            break
                        } n && (n.url = u.makeUrl(n.url), e.src !== n.url && (u.restrictsMixedContent() && "http:" === n.url.substr(0, "http:".length).toLowerCase() ? void 0 !== window.console && console.warn("Blocked mixed content image " + n.url) : (e.src = n.url, u.curSrcSupported || (e.currentSrc = e.src), u.backfaceVisibilityFix(e))), u.setIntrinsicSize(e, n))
                }, u.ascendingSort = function(t, e) {
                    return t.resolution - e.resolution
                }, u.removeVideoShim = function(t) {
                    var e = t.getElementsByTagName("video");
                    if (e.length) {
                        for (var i = e[0], o = i.getElementsByTagName("source"); o.length;) t.insertBefore(o[0], i);
                        i.parentNode.removeChild(i)
                    }
                }, u.getAllElements = function() {
                    for (var t = [], e = c.getElementsByTagName("img"), i = 0, o = e.length; i < o; i++) {
                        var n = e[i];
                        ("PICTURE" === n.parentNode.nodeName.toUpperCase() || null !== n.getAttribute("srcset") || n[u.ns] && null !== n[u.ns].srcset) && t.push(n)
                    }
                    return t
                }, u.getMatch = function(t, e) {
                    for (var i, o = e.childNodes, n = 0, s = o.length; n < s; n++) {
                        ...
                        if (1 === r.nodeType) {
                            ...
                            if ("SOURCE" === r.nodeName.toUpperCase()) {
                                ...
                                if (r.getAttribute("srcset") && (!a || u.matchesMedia(a))) {
                                    var l = u.verifyTypeSupport(r);
                                    if (!0 === l) {
                                        i = r;
                                        break
                                    }
                ...
                function() {
                    ...
                    var i, o = setInterval(function() {
                        return n(), /^loaded|^i|^c/.test(c.readyState) ? void clearInterval(o) : void 0
                    }, 250);
                    d.addEventListener ? d.addEventListener("resize", t, !1) : d.attachEvent && d.attachEvent("onresize", t)
                }(), n._ = u, e(n)
        }
    ...
    function(t, e) {
        ...
        ! function() {
            ...
            e.prototype.init = function() {
                ...
                var e, i, o = null;
                if (this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? e = this.s.dynamicEl[t].subHtmlUrl : o = this.s.dynamicEl[t].subHtml : (i = this.$items.eq(t)).attr("data-sub-html-url") ? e = i.attr("data-sub-html-url") : (o = i.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !o && (o = i.attr("title") || i.find("img").first().attr("alt"))), !e)
                    if (null != o) {
                        var n = o.substring(0, 1);
                        "." !== n && "#" !== n || (o = this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(o).html() : m(o).html())
                    } else o = "";
                ".lg-sub-html" === this.s.appendSubHtmlTo ? e ? this.$outer.find(this.s.appendSubHtmlTo).load(e) : this.$outer.find(this.s.appendSubHtmlTo).html(o) : e ? this.$slide.eq(t).load(e) : this.$slide.eq(t).append(o), null != o && ("" === o ? this.$outer.find(this.s.appendSubHtmlTo).addClass("lg-empty-html") : this.$outer.find(this.s.appendSubHtmlTo).removeClass("lg-empty-html")), this.$el.trigger("onAfterAppendSubHtml.lg", [t])
                ...
                function o(t) {
                    ...
                    for (var s = m(window).width(), r = 0; r < e.length; r++)
                ...
                var n, a, s, r, l, d, c = this,
                    u = !1;
                l = c.s.dynamic ? (c.s.dynamicEl[e].poster && (u = !0, s = c.s.dynamicEl[e].poster), d = c.s.dynamicEl[e].html, a = c.s.dynamicEl[e].src, c.s.dynamicEl[e].responsive && o(c.s.dynamicEl[e].responsive.split(",")), r = c.s.dynamicEl[e].srcset, c.s.dynamicEl[e].sizes) : (c.$items.eq(e).attr("data-poster") && (u = !0, s = c.$items.eq(e).attr("data-poster")), d = c.$items.eq(e).attr("data-html"), a = c.$items.eq(e).attr("href") || c.$items.eq(e).attr("data-src"), c.$items.eq(e).attr("data-responsive") && o(c.$items.eq(e).attr("data-responsive").split(",")), r = c.$items.eq(e).attr("data-srcset"), c.$items.eq(e).attr("data-sizes"));
                var h = !1;
                c.s.dynamic ? c.s.dynamicEl[e].iframe && (h = !0) : "true" === c.$items.eq(e).attr("data-iframe") && (h = !0);
                var p = c.isVideo(a, e);
                if (!c.$slide.eq(e).hasClass("lg-loaded")) {
                    if (h) c.$slide.eq(e).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>');
                    else if (u) {
                        var f;
                        f = p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5", c.$slide.eq(e).prepend('<div class="lg-video-cont ' + f + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + s + '" /></div></div>')
                    } else p ? (c.$slide.eq(e).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'), c.$el.trigger("hasVideo.lg", [e, a, d])) : c.$slide.eq(e).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + a + '" /></div>');
                ...
                if (!s.lGalleryOn || n !== t) {
                    ...
                    if (!s.lgBusy) {
                        var l, d, c;
                        if (this.s.download)(l = s.s.dynamic ? !1 !== s.s.dynamicEl[t].downloadUrl && (s.s.dynamicEl[t].downloadUrl || s.s.dynamicEl[t].src) : "false" !== s.$items.eq(t).attr("data-download-url") && (s.$items.eq(t).attr("data-download-url") || s.$items.eq(t).attr("href") || s.$items.eq(t).attr("data-src"))) ? (m("#lg-download").attr("href", l), s.$outer.removeClass("lg-hide-download")) : s.$outer.addClass("lg-hide-download");
                        if (this.$el.trigger("onBeforeSlide.lg", [n, t, e, i]), s.lgBusy = !0, clearTimeout(s.hideBartimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function() {
                                s.addHtml(t)
                            }, a), this.arrowDisable(t), o || (t < n ? o = "prev" : n < t && (o = "next")), e) this.$slide.removeClass("lg-prev-slide lg-current lg-next-slide"), 2 < r ? (d = t - 1, c = t + 1, (0 === t && n === r - 1 || t === r - 1 && 0 === n) && (c = 0, d = r - 1)) : (d = 0, c = 1), "prev" === o ? s.$slide.eq(c).addClass("lg-next-slide") : s.$slide.eq(d).addClass("lg-prev-slide"), s.$slide.eq(t).addClass("lg-current");
                        else s.$outer.addClass("lg-no-trans"), this.$slide.removeClass("lg-prev-slide lg-next-slide"), "prev" === o ? (this.$slide.eq(t).addClass("lg-prev-slide"), this.$slide.eq(n).addClass("lg-next-slide")) : (this.$slide.eq(t).addClass("lg-next-slide"), this.$slide.eq(n).addClass("lg-prev-slide")), setTimeout(function() {
                        ...
                        s.lGalleryOn ? (setTimeout(function() {
                            ...
                            s.lgBusy = !1, s.$el.trigger("onAfterSlide.lg", [n, t, e, i])
                        }, this.s.speed)) : (s.loadContent(t, !0, s.s.backdropDuration), s.lgBusy = !1, s.$el.trigger("onAfterSlide.lg", [n, t, e, i])), s.lGalleryOn = !0, this.s.counter && m("#lg-counter-current").text(t + 1)
                    }
                    s.index = t
                }
                ...
                e.s.enableDrag && e.doCss() && (e.$slide.on("mousedown.lg", function(t) {
                    e.$outer.hasClass("lg-zoomed") || e.lgBusy || m(t.target).text().trim() || (t.preventDefault(), e.manageSwipeClass(), i = t.pageX, n = !0, e.$outer.scrollLeft += 1, --e.$outer.scrollLeft, e.$outer.removeClass("lg-grab").addClass("lg-grabbing"), e.$el.trigger("onDragstart.lg"))
                    ...
                    s ? (s = !1, e.touchEnd(o - i), e.$el.trigger("onDragend.lg")) : (m(t.target).hasClass("lg-object") || m(t.target).hasClass("lg-video-play")) && e.$el.trigger("onSlideClick.lg"), n && (n = !1, e.$outer.removeClass("lg-grabbing").addClass("lg-grab"))
                }))
    ...
    function(e) {
        ...
        ! function() {
            ...
            function t(t) {
                return this.core = d(t).data("lightGallery"), this.core.s = d.extend({}, e, this.core.s), this.$el = d(t), this.$thumbOuter = null, this.thumbOuterWidth = 0, this.thumbTotalWidth = this.core.$items.length * (this.core.s.thumbWidth + this.core.s.thumbMargin), this.thumbIndex = this.core.index, this.core.s.animateThumb && (this.core.s.thumbHeight = "100%"), this.left = 0, this.init(), this
            }
            var e = {
                thumbnail: !0,
                animateThumb: !0,
            ...
            t.prototype.init = function() {
                ...
                if (r.core.$outer.addClass("lg-has-thumb"), r.core.$outer.find(".lg").append('<div class="lg-thumb-outer"><div class="lg-thumb lg-group"></div></div>'), r.$thumbOuter = r.core.$outer.find(".lg-thumb-outer"), r.thumbOuterWidth = r.$thumbOuter.width(), r.core.s.animateThumb && r.core.$outer.find(".lg-thumb").css({
                    ...
                    for (var i = 0; i < r.core.s.dynamicEl.length; i++) e(r.core.s.dynamicEl[i].src, r.core.s.dynamicEl[i].thumb, i);
                else r.core.$items.each(function(t) {
                    r.core.s.exThumbImage ? e(d(this).attr("href") || d(this).attr("data-src"), d(this).attr(r.core.s.exThumbImage), t) : e(d(this).attr("href") || d(this).attr("data-src"), d(this).find("img").attr("src"), t)
                });
                r.core.$outer.find(".lg-thumb").html(a), (t = r.core.$outer.find(".lg-thumb-item")).each(function() {
                    var e = d(this),
                        t = e.attr("data-vimeo-id");
                    t && d.getJSON("//www.vimeo.com/api/v2/video/" + t + ".json?callback=?", {
                        format: "json"
                    }, function(t) {
                        e.find("img").attr("src", t[0][r.core.s.vimeoThumbSize])
                    })
                }), t.eq(r.core.index).addClass("active"), r.core.$el.on("onBeforeSlide.lg.tm", function() {
                    t.removeClass("active"), t.eq(r.core.index).addClass("active")
                }), t.on("click.lg touchend.lg", function() {
                    var t = d(this);
                    setTimeout(function() {
                        (!r.thumbClickable || r.core.lgBusy) && r.core.doCss() || (r.core.index = t.index(), r.core.slide(r.core.index, !1, !0, !1))
                    }, 50)
                ...
                }), d(window).on("mousemove.lg.thumb", function(t) {
                ...
                var e = this;
                d(window).on("keydown.lg.thumb", function(t) {
            ...
            }, d.fn.lightGallery.modules.Thumbnail = t
        }()
    }),
    function(t, e) {
        "function" == typeof define && define.amd ? define(["jquery"], function(t) {
        ...
        ! function() {
            ...
            function t(t) {
                return this.core = h(t).data("lightGallery"), this.$el = h(t), this.core.s = h.extend({}, e, this.core.s), this.videoLoaded = !1, this.init(), this
            }
            var e = {
                videoMaxWidth: "855px",
            ...
            t.prototype.init = function() {
                ...
                o.core.$el.on("hasVideo.lg.tm", function(t, e, i, o) {
                    ...
                    d && h(d).attr("src", h(d).attr("src").replace("&autoplay", "&noplay")), o = n.core.s.dynamic ? n.core.s.dynamicEl[i].src : n.core.$items.eq(i).attr("href") || n.core.$items.eq(i).attr("data-src");
                    var u = n.core.isVideo(o, i) || {};
                ...
                var s = "",
                    r = 1,
                    a = "",
                    l = this.core.isVideo(t, o) || {};
                if (i && (r = !this.videoLoaded && this.core.s.autoplayFirstVideo ? 1 : 0), l.youtube) a = "?wmode=opaque&autoplay=" + r + "&enablejsapi=1", this.core.s.youtubePlayerParams && (a = a + "&" + h.param(this.core.s.youtubePlayerParams)), s = '<iframe class="lg-video-object lg-youtube ' + e + '" width="560" height="315" src="//www.youtube.com/embed/' + l.youtube[1] + a + '" frameborder="0" allowfullscreen></iframe>';
                else if (l.vimeo) a = "?autoplay=" + r + "&api=1", this.core.s.vimeoPlayerParams && (a = a + "&" + h.param(this.core.s.vimeoPlayerParams)), s = '<iframe class="lg-video-object lg-vimeo ' + e + '" width="560" height="315"  src="//player.vimeo.com/video/' + l.vimeo[1] + a + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                else if (l.dailymotion) a = "?wmode=opaque&autoplay=" + r + "&api=postMessage", this.core.s.dailymotionPlayerParams && (a = a + "&" + h.param(this.core.s.dailymotionPlayerParams)), s = '<iframe class="lg-video-object lg-dailymotion ' + e + '" width="560" height="315" src="//www.dailymotion.com/embed/video/' + l.dailymotion[1] + a + '" frameborder="0" allowfullscreen></iframe>';
                else if (l.html5) {
                    var d = n.substring(0, 1);
                    "." !== d && "#" !== d || (n = h(n).html()), s = n
                } else l.vk && (a = "&autoplay=" + r, this.core.s.vkPlayerParams && (a = a + "&" + h.param(this.core.s.vkPlayerParams)), s = '<iframe class="lg-video-object lg-vk ' + e + '" width="560" height="315" src="//vk.com/video_ext.php?' + l.vk[1] + a + '" frameborder="0" allowfullscreen></iframe>');
                return s
                ...
                if (i.find(".lg-object").hasClass("lg-has-poster") && i.find(".lg-object").is(":visible"))
                    if (i.hasClass("lg-has-video")) {
                        ...
                        a = o.core.s.dynamic ? (r = o.core.s.dynamicEl[o.core.index].src, o.core.s.dynamicEl[o.core.index].html) : (r = o.core.$items.eq(o.core.index).attr("href") || o.core.$items.eq(o.core.index).attr("data-src"), o.core.$items.eq(o.core.index).attr("data-html")), l(r, a);
    ...
    function(e) {
        ...
        ! function() {
            ...
            function t(t) {
                return this.core = u(t).data("lightGallery"), this.core.s = u.extend({}, o, this.core.s), this.core.s.zoom && this.core.doCss() && (this.init(), this.zoomabletimeout = !1, this.pageX = u(window).width() / 2, this.pageY = u(window).height() / 2 + u(window).scrollTop()), this
            }
            var e, i, o = {
                scale: 1,
                zoom: !0,
            ...
            t.prototype.init = function() {
                ...
                r.core.s.actualSize && (t += '<span id="lg-actual-size" class="lg-icon"></span>'), r.core.s.useLeftForZoom ? r.core.$outer.addClass("lg-use-left-for-zoom") : r.core.$outer.addClass("lg-use-transition-for-zoom"), this.core.$outer.find(".lg-toolbar").append(t), r.core.$el.on("onSlideItemLoad.lg.tm.zoom", function(t, e, i) {
                    var o = r.core.s.enableZoomAfter + i;
                    u("body").hasClass("lg-from-hash") && i ? o = 0 : u("body").removeClass("lg-from-hash"), r.zoomabletimeout = setTimeout(function() {
                ...
                function e(t) {
                    var e = r.core.$outer.find(".lg-current .lg-image"),
                        ...
                        o = (u(window).height() - e.prop("offsetHeight")) / 2 + u(window).scrollTop(),
                        n = (t - 1) * (r.pageX - i),
                        s = (t - 1) * (r.pageY - o);
                    e.css("transform", "scale3d(" + t + ", " + t + ", 1)").attr("data-scale", t), r.core.s.useLeftForZoom ? e.parent().css({
                        left: -n + "px",
                        top: -s + "px"
                    }).attr("data-x", n).attr("data-y", s) : e.parent().css("transform", "translate3d(-" + n + "px, -" + s + "px, 0)").attr("data-x", n).attr("data-y", s)
                }
                ...
                function o(t, e, i, o) {
                    var n, s = e.prop("offsetWidth");
                    n = r.core.s.dynamic ? r.core.s.dynamicEl[i].width || e[0].naturalWidth || s : r.core.$items.eq(i).attr("data-width") || e[0].naturalWidth || s, r.core.$outer.hasClass("lg-zoomed") ? l = 1 : s < n && (l = n / s || 2), o ? (r.pageX = u(window).width() / 2, r.pageY = u(window).height() / 2 + u(window).scrollTop()) : (r.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX, r.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY), a(), setTimeout(function() {
                ...
                r.core.$el.on("onAferAppendSlide.lg.tm.zoom", function(t, e) {
                    ...
                    r.pageX = u(window).width() / 2, r.pageY = u(window).height() / 2 + u(window).scrollTop(), e(l)
                    ...
                    o(t, r.core.$slide.eq(r.core.index).find(".lg-image"), r.core.index, !0)
                }), r.core.$el.on("onBeforeSlide.lg.tm", function() {
                    l = 1, r.resetZoom()
                ...
                n.core.$slide.on("touchstart.lg", function(t) {
                    if (n.core.$outer.hasClass("lg-zoomed")) {
                        ...
                        d = e.prop("offsetHeight") * e.attr("data-scale") > n.core.$outer.find(".lg").height(), ((l = e.prop("offsetWidth") * e.attr("data-scale") > n.core.$outer.find(".lg").width()) || d) && (t.preventDefault(), s = {
                    ...
                    if (n.core.$outer.hasClass("lg-zoomed")) {
                        var e, i, o = n.core.$slide.eq(n.core.index).find(".lg-img-wrap");
                        t.preventDefault(), a = !0, r = {
                            x: t.originalEvent.targetTouches[0].pageX,
                            y: t.originalEvent.targetTouches[0].pageY
                        }, n.core.$outer.addClass("lg-zoom-dragging"), i = d ? -Math.abs(o.attr("data-y")) + (r.y - s.y) : -Math.abs(o.attr("data-y")), e = l ? -Math.abs(o.attr("data-x")) + (r.x - s.x) : -Math.abs(o.attr("data-x")), (15 < Math.abs(r.x - s.x) || 15 < Math.abs(r.y - s.y)) && (n.core.s.useLeftForZoom ? o.css({
                            left: e + "px",
                            top: i + "px"
                        }) : o.css("transform", "translate3d(" + e + "px, " + i + "px, 0)"))
                    }
                }), n.core.$slide.on("touchend.lg", function() {
                    n.core.$outer.hasClass("lg-zoomed") && a && (a = !1, n.core.$outer.removeClass("lg-zoom-dragging"), n.touchendZoom(s, r, l, d))
                })
                ...
                n.core.$slide.on("mousedown.lg.zoom", function(t) {
                    var e = n.core.$slide.eq(n.core.index).find(".lg-object");
                    c = e.prop("offsetHeight") * e.attr("data-scale") > n.core.$outer.find(".lg").height(), d = e.prop("offsetWidth") * e.attr("data-scale") > n.core.$outer.find(".lg").width(), n.core.$outer.hasClass("lg-zoomed") && u(t.target).hasClass("lg-object") && (d || c) && (t.preventDefault(), s = {
                        x: t.pageX,
                        y: t.pageY
                    }, a = !0, n.core.$outer.scrollLeft += 1, --n.core.$outer.scrollLeft, n.core.$outer.removeClass("lg-grab").addClass("lg-grabbing"))
                    ...
                    if (a) {
                        ...
                        l = !0, r = {
                            x: t.pageX,
                            y: t.pageY
                        }, n.core.$outer.addClass("lg-zoom-dragging"), i = c ? -Math.abs(o.attr("data-y")) + (r.y - s.y) : -Math.abs(o.attr("data-y")), e = d ? -Math.abs(o.attr("data-x")) + (r.x - s.x) : -Math.abs(o.attr("data-x")), n.core.s.useLeftForZoom ? o.css({
                            left: e + "px",
                            top: i + "px"
                        }) : o.css("transform", "translate3d(" + e + "px, " + i + "px, 0)")
                    }
                }), u(window).on("mouseup.lg.zoom", function(t) {
                    a && (a = !1, n.core.$outer.removeClass("lg-zoom-dragging"), !l || s.x === r.x && s.y === r.y || (r = {
                        x: t.pageX,
                        y: t.pageY
                    }, n.touchendZoom(s, r, d, c)), l = !1), n.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
                })
                ...
                var n = this,
                    ...
                    h = Math.abs(r.prop("offsetWidth") * Math.abs(r.attr("data-scale")) - n.core.$outer.find(".lg").width() + u);
                (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) && (o && (l <= -c ? l = -c : -d <= l && (l = -d)), i && (a <= -h ? a = -h : -u <= a && (a = -u)), o ? s.attr("data-y", Math.abs(l)) : l = -Math.abs(s.attr("data-y")), i ? s.attr("data-x", Math.abs(a)) : a = -Math.abs(s.attr("data-x")), n.core.s.useLeftForZoom ? s.css({
                    left: a + "px",
                    top: l + "px"
    ...
    function(t) {
        ...
        function e(t) {
            var e = t || window.event,
                ...
                a = 0,
                l = 0;
            if ((t = h.event.fix(e)).type = "mousewheel", "detail" in e && (s = -1 * e.detail), "wheelDelta" in e && (s = e.wheelDelta), "wheelDeltaY" in e && (s = e.wheelDeltaY), "wheelDeltaX" in e && (n = -1 * e.wheelDeltaX), "axis" in e && e.axis === e.HORIZONTAL_AXIS && (n = -1 * s, s = 0), o = 0 === s ? n : s, "deltaY" in e && (o = s = -1 * e.deltaY), "deltaX" in e && (n = e.deltaX, 0 === s && (o = -1 * n)), 0 !== s || 0 !== n) {
                if (1 === e.deltaMode) {
                ...
                if (r = Math.max(Math.abs(s), Math.abs(n)), (!g || r < g) && (f(e, g = r) && (g /= 40)), f(e, r) && (o /= 40, n /= 40, s /= 40), o = Math[1 <= o ? "floor" : "ceil"](o / g), n = Math[1 <= n ? "floor" : "ceil"](n / g), s = Math[1 <= s ? "floor" : "ceil"](s / g), y.settings.normalizeOffset && this.getBoundingClientRect) {
                    var u = this.getBoundingClientRect();
                    a = t.clientX - u.left, l = t.clientY - u.top
                }
                return t.deltaX = n, t.deltaY = s, t.deltaFactor = g, t.offsetX = a, t.offsetY = l, t.deltaMode = 0, i.unshift(t, o, n, s), m && clearTimeout(m), m = setTimeout(p, 200), (h.event.dispatch || h.event.handle).apply(this, i)
            }
        }
